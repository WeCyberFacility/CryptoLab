...
public class EncryptionWahl extends AppCompatActivity {
    ...
    public void verschluesselungenLaden(){
        ...
        Verschluesselung faktorization = new Verschluesselung("3", "Faktorization", 2,
                ...
                "Primfaktoren, aufsteigend sortiert und mit Sternchen(*) getrennt als String. (z.B.: 2*2*5*7)");
        Verschluesselung vignere = new Verschluesselung("4", "Vignere", 3,
                ...
                "Klartext als ein String (Groß‐/Kleinschreibung wird nicht berücksichtigt)");
        Verschluesselung desKeyschedule = new Verschluesselung("5", "DES Key-Schedule", 3,
                ...
                "Roundkey als ein Binär‐String (48Bit) (z.B. „1001111011…“)");
        Verschluesselung desrblock = new Verschluesselung("6", "DES R-Block", 3,
                ...
                "R‐Block als Binär‐String (z.B. „1001111011…“)");
        Verschluesselung desfeistel = new Verschluesselung("7", "DES Feistel", 4,
                ...
                "L-Block XOR R-Block als Binär-String");
        Verschluesselung desround = new Verschluesselung("8", "DES Round", 5,
                ...
                "Binär‐String (64Bit, zuerst L‐Block 32Bit dann R‐Block 32Bit) (z.B.„1001111011…“)");
        Verschluesselung aesgf8 = new Verschluesselung("9", "AES GF8", 2,
                ...
                "Ergebnis der GF8‐Multiplikation als HEX‐String (Groß‐/Kleinschreibung wird nicht berücksichtigt.) (z.B. „2f“)");
        Verschluesselung aeskeyexpansion = new Verschluesselung("10", "AES Key-Expansion", 4,
                ...
                "HEX‐String aller drei Rundenschlüssel (jeweils 128 Bit) jeweils durch einen Unterstrich („_“) getrennt (z.B. „a56e…_35c…_72a…“)");
        Verschluesselung aesmixcolumns = new Verschluesselung("11", "AES Mix-Columns", 4,
                ...
                "HEX‐String (128Bit)",
                "Gemischte Spalten als ein HEX‐String (128Bit) (z.B. „21ae5….“)");
        ...
        Verschluesselung aes3rounds = new Verschluesselung("13", "AES 3-Rounds", 5,
                ...
                "Ausgabe (des verschlüsselten Textes) aller drei Runden als ein HEX‐String (128Bit), wobei die verschlüsselten Texte der Reihenfolge nach sortiert sind und jeweils durch einen Unterstrich („_“) getrennt werden (z.B. 34e2…_e7c…_a45b…)");
        Verschluesselung rc4loop = new Verschluesselung("14", "RC4 Loop", 3,
                ...
                "Inhalt des State‐Tables an der Stelle t des jeweiligen Loops. Alle Werte werden in einem String (ohne Trennzeichen) hintereinander ausgegeben. (z.B. „2130“)");
        Verschluesselung rc4keyschedule = new Verschluesselung("15", "RC4 Key-Schedule", 4,
                ...
                "State‐Table (Integer‐Werte durch Unterstrich („_“) getrennt. z.B.: 2_1_3_0 wären die State‐Table‐Werte an den Positionen null bis drei)");
        Verschluesselung rc4encryption = new Verschluesselung("16", "RC4 Encryption", 5,
                ...
                "Chiffretext als ein Binär‐String (z.B. „1000111101011…“)");
